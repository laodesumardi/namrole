<?php
/**
 * Fix Hosting Permissions - Complete Solution
 * Solusi untuk masalah "Permission denied" di hosting
 */

echo "=== FIX HOSTING PERMISSIONS ===\n";
echo "Memperbaiki permission denied di hosting...\n\n";
...
foreach ($files as $file) {
    if (is_file($file)) {
        chmod($file, 0644);
        echo "✅ Set permission 644 for: " . basename($file) . "\n";
    }
}

// 3. Copy images to public storage
echo "\n3. Copy images to public storage...\n";
$sourceDirs = [
...
// 4. Create .htaccess for public storage
echo "\n4. Creating .htaccess for public storage...\n";
...
?>';
file_put_contents(__DIR__ . '/public/deploy_permissions.php', $deployScript);
echo "✅ Created deployment script: public/deploy_permissions.php\n";
...
echo "2. Run: php public/deploy_permissions.php\n";
echo "3. Test website: https://uji.odetune.shop/\n";
echo "4. Images should now appear correctly!\n";
?>
