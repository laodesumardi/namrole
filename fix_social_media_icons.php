 ...
 * 
 * This script fixes social media icons in admin page
 * Specifically for http://localhost:8000/admin/social-media
 */

echo "🔧 Fixing Social Media Icons\n";
echo "============================\n\n";

echo "🔧 Fixing social media icons in admin page...\n";
...
// 2. Fix SocialMedia model
echo "\n🔧 Fixing SocialMedia model...\n";
...
class SocialMedia extends Model
{
    ...
    /**
     * Get active social media links ordered by sort_order
     */
    ...
    public function getPlatformNameAttribute()
    {
        ...
        $platform = strtolower($this->icon);
        return $platforms[$platform] ?? ucfirst($this->icon);
    }
}';

if (file_put_contents('app/Models/SocialMedia.php', $socialMediaModelContent)) {
    echo "✅ SocialMedia model updated\n";
} else {
    echo "❌ Failed to update SocialMedia model\n";
}

// 3. Fix admin social media index view
echo "\n🔧 Fixing admin social media index view...\n";
...
// 4. Create sample social media data
...
try {
    ...
    echo "✅ Sample Facebook social media created\n";
} catch (Exception $e) {
    echo "⚠️ Sample Facebook social media already exists or failed: " . $e->getMessage() . "\n";
}
...
try {
    ...
    echo "✅ Sample Instagram social media created\n";
} catch (Exception $e) {
    echo "⚠️ Sample Instagram social media already exists or failed: " . $e->getMessage() . "\n";
}
...
try {
    ...
    echo "✅ Sample YouTube social media created\n";
} catch (Exception $e) {
    echo "⚠️ Sample YouTube social media already exists or failed: " . $e->getMessage() . "\n";
}
...
try {
    ...
    echo "✅ Sample WhatsApp social media created\n";
} catch (Exception $e) {
    echo "⚠️ Sample WhatsApp social media already exists or failed: " . $e->getMessage() . "\n";
}
...
$testPath = 'public/test-social-media-icons.php';
if (file_put_contents($testPath, $testContent)) {
    echo "✅ test-social-media-icons.php created\n";
    echo "🌐 You can access: http://localhost:8000/test-social-media-icons.php\n";
} else {
    echo "❌ Failed to create test-social-media-icons.php\n";
}

echo "\n✅ Social media icons fix completed!\n";
...
echo "- Created sample social media data (Facebook, Instagram, YouTube, WhatsApp)\n";
echo "- Added platform name attribute\n";
echo "- Enhanced icon HTML generation\n";
echo "- Tested SocialMedia model functionality\n";
echo "- Created test script\n\n";

echo "🌐 Test URLs:\n";
echo "- Social Media Icons Test: http://localhost:8000/test-social-media-icons.php\n";
echo "- Admin Social Media: http://localhost:8000/admin/social-media\n";
echo "- Website: http://localhost:8000/\n";
echo "- Admin: http://localhost:8000/admin\n\n";

echo "📝 Next Steps:\n";
echo "1. Test: http://localhost:8000/test-social-media-icons.php\n";
