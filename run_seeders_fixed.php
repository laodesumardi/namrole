<?php
/**
 * Run Seeders - Fixed Version
 * 
 * This script runs database seeders with error handling
 * Specifically for missing models and seeder issues
 */

echo "🌱 Running Database Seeders - Fixed Version\n";
echo "===========================================\n\n";

echo "🔧 Running database seeders with error handling...\n";
...
// 3. Run seeders with error handling
echo "\n🌱 Running seeders with error handling...\n";
...
foreach ($seeders as $seeder) {
    try {
        ...
        echo "⚠️ $seeder failed: " . $e->getMessage() . "\n";
        echo "🔧 Skipping $seeder and continuing...\n";
    }
}

// 4. Create sample data manually
...
echo "- Ran all database seeders with error handling\n";
